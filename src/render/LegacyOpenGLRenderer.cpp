...
void LegacyOpenGLRenderer::RegisterEmitter(CAbstractParticleEmitter *emitter)
{
...
void LegacyOpenGLRenderer::DrawParticles(const ParticleCollection<glm::mat4> &collection, GLuint vbo, bool useAlphaBuffer)
{
